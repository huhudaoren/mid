...
@Controller
@RequestMapping(value = "wt/jianshe03/admin")
public class Jianshe03AdminController {
    ...
    public String index(Model model){
        ...
        return "jianshe/jiansheAdmin03/index";
    }


    @RequestMapping(value = "/jianshe03poi", method = RequestMethod.GET)
