	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www24.53kf.com/webCompany.php?kf_sign=TMwMDMTU3MI0ODEwNzU5OTY5MjcxMDE1NzIyMDAxMzY=&arg=10200136&style=1&kflist=off&kf=nhlap985%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F3w.mj2812.cn%2Fwp%2Fniuhwap%2F&keyword=&brief=&logo=&question=&uid=9fc3ca6a5b41d0f5f997e3561199c219";
		try{
...
//	hz6d_get_guest_id_timer = setTimeout("hz6d_get_guest_id()", 500);
	...
	var create_flp_jquery_timer = window.setInterval(function(){
		if (!document.getElementById('hz6d_flp_jquery')) {
			$53.creElm({
				id: 'hz6d_flp_jquery',
				src: 'https://www24.53kf.com/minkh/js/jquery-1.4.2.flp.js?20121127002',
				charset: "utf-8",
	...
	function hz6d_re_flashing(cid) {
		...
		var ivt_autotype			= "0";
		var zdyivt					= "0";
		var ivtstr					= "<div id=\"acc_title\" style=\"cursor:pointer;height:23px;width:100%;position:relative; line-height:23px\">  <div style=\"float:left;width:8px; background:url(https://www24.53kf.com/img/new06/fu-t-l.gif) no-repeat; height:23px;\"></div>  <div style=\"float:left;width:384px;height:23px; background:url(https://www24.53kf.com/img/new06/fu-t-c.gif) repeat-x ;line-height:23px;color:#ffffff;text-align:left;\">53KF&#36992;&#35831;</div>  <div style=\"float:left;width:8px; background:url(https://www24.53kf.com/img/new06/fu-t-r.gif) no-repeat; height:23px;\"></div></div><div style=\"clear:both;width:400px;background:url(https://www24.53kf.com/img/ivt/53kf01bg.gif);height:auto; overflow:hidden;\">  <div style=\"float:left;height:100%;width:100px;background: url(https://www24.53kf.com/img/ivt/53kf01bg.gif) left;   text-align:center;\"><img style=\"DISPLAY: inline;margin-top:10px;cursor:pointer;\" src=\"https://www24.53kf.com/img/kflogo/ivt_cn.gif\"/></div>  <div style=\"float:right;height:auto;*height:auto;*height:auto !important;width:300px;*width:298px;* width:295px !important; background:url(https://www24.53kf.com/img/ivt/53kf01bg.gif) right; text-align:left;\">    <div style=\"clear:both;width:95%;padding-top:10px; text-align:left;line-height:17px;font-family:tahoma;font-size:12px;color:#000000; height:auto; overflow:hidden;\">		&#27426;&#36814;&#24744;&#65281; <br /><span id=\"hz6d_acc_content\">acc_content</span></div>    <div style=\"clear:both;width:95%;margin-top:5px;text-align:right;\"><button id=\"hz6d_53kf_invite_acc\" onclick=\';onliner_zdfq=2;window.open(\"talk_openurl\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();\' style=\"DISPLAY: inline; cursor:pointer;height:24px;width:76px;border:0px;background:none;\"><img style=\"DISPLAY: inline;\" src=\"https://www24.53kf.com/img/new06/fu-button1_cn.gif\" /></button>&nbsp;&nbsp;<button onclick=\';onliner_zdfq=3;hidden_ivt();\' style=\"DISPLAY: inline;cursor:pointer;height:24px;width:76px;border:0px;background:none;\"><img style=\"DISPLAY: inline;\" src=\"https://www24.53kf.com/img/new06/fu-button2_cn.gif\" id=\"hz6d_53kf_invite_hid\" /></button></div></div></div><div style=\"height:8px;width:100%;clear:both; line-height:8px; float:left;\">  <div style=\"height:8px;width:8px;float:left; background:url(https://www24.53kf.com/img/new06/fu-b-l.gif) no-repeat;line-height:8px;\"></div>    <div style=\"height:8px;width:384px;float:left; background:url(https://www24.53kf.com/img/new06/fu-b-c.gif) repeat-x;line-height:8px;\"></div>    <div style=\"height:8px;width:8px;float:right; background:url(https://www24.53kf.com/img/new06/fu-b-r.gif) no-repeat;line-height:8px;\"></div></div>";
		var is_autoyqk				= "0";
	...
	//	var acc_poptype				= -1;
		...
		if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			...
			Inv.prototype = {
				...
				talk : function(){
					...
					if (zdfq_type == 3) {
						...
						var openurl = "https://www24.53kf.com/webCompany.php?kf_sign=TMwMDMTU3MI0ODEwNzU5OTY5MjcxMDE1NzIyMDAxMzY=&arg=10200136&style=1&kflist=off&kf=nhlap985%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F3w.mj2812.cn%2Fwp%2Fniuhwap%2F&keyword=&brief=&logo=&question=&uid=9fc3ca6a5b41d0f5f997e3561199c219&tfrom=2" + force_kf;
						onliner_zdfq=2;
			...
			if(1 == 1){
				btn_style1 = 'background: center center no-repeat;background-image: url(https://www24.53kf.com/style/chat/new2017/image/png/img-info24.png);background-image: url(https://www24.53kf.com/style/chat/new2017/image/svg/img-info24.svg), none;'
				btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www24.53kf.com/style/chat/new2017/image/png/img-info36.png);background-image: url(https://www24.53kf.com/style/chat/new2017/image/svg/img-info36.svg), none;'
			}else {
				btn_style1 = 'background: center center no-repeat;background-image: url(https://www24.53kf.com/style/chat/new2017/image/png/img-email24.png);background-image: url(https://www24.53kf.com/style/chat/new2017/image/svg/img-email24.svg), none;'
				btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www24.53kf.com/style/chat/new2017/image/png/img-email36.png);background-image: url(https://www24.53kf.com/style/chat/new2017/image/svg/img-email36.svg), none;'
			}
			...
			if(mini_style_type==1){
				bubble_html = '<div class="mini-btn mini-btn1" id="mini-btn" onclick="show_floatWindow();" style="width:auto;white-space:nowrap;cursor:pointer;'+mini_btn_display+'position:absolute;'+mini_button_position+'z-index:-1;height: 42px;border-radius:2px; overflow: hidden; background: '+minicolor_tbbj+';-webkit-box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;">'+
									...
									'<div class="mini-btn-window" style="display:inline-block;width: 42px;height: 42px;background: center center no-repeat;background-image: url(https://www24.53kf.com/style/chat/new2017/image/png/to-maxWindow.png);background-image: url(https://www24.53kf.com/style/chat/new2017/image/svg/to-maxWindow.svg), none;"></div>'+
								'</div>';
			...
			tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
								'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 10px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
									'<img style="max-width: 80px;width:auto;height:24px;float: left;margin-top: 6px;border-radius:2px;" src="https://www24.53kf.com/img/upload/10200136/mobile/temp/mobile_53kf_1555494662.jpg"/>'+
	...
	function cgpic(t){
		if( $53("div_company_mini").style.width =="400px"){
			document.querySelector('.mini_narrow').style.background="url('https://www24.53kf.com/style/chat/minichat2/img/minx1.png') no-repeat";
		}

	}
	function cgpic2(t){
		if( $53("div_company_mini").style.width =="400px"){
			document.querySelector('.mini_narrow').style.background="url('https://www24.53kf.com/style/chat/minichat2/img/minx2.png') no-repeat";
		}
	}
	function cgpic3(t){
		document.querySelector('.mini_maxto').style.background="url('https://www24.53kf.com/style/chat/minichat2/img/double1.png') no-repeat";
	}
	function cgpic4(t){
		document.querySelector('.mini_maxto').style.background="url('https://www24.53kf.com/style/chat/minichat2/img/double2.png') no-repeat";
	}
	function cgpic5(t){
		document.querySelector('.mini_close').style.background="url('https://www24.53kf.com/style/chat/minichat2/img/close1.png') no-repeat 50% 50%";
	}
	function cgpic6(t){
		document.querySelector('.mini_close').style.background="url('https://www24.53kf.com/style/chat/minichat2/img/close2.png') no-repeat 50% 50%";
	}
	...
	function max_min_company_mini(t)
	{
		if (t.getAttribute('max_min') == 'max')
		{
			...
			t.style.backgroundImage = "url('https://www24.53kf.com/style/chat/minichat2/img/max.png')";
			t.setAttribute('max_min','min');
			t.title = t.getAttribute('mini_recover');
			$53("div_company_mini").style.right = '0px';
			$53("div_company_mini").style.bottom = '0px';			$53("mini_header_bg_div").style.backgroundImage = "url('https://www24.53kf.com/style/chat/minichat2/img/header_bg2_1.png')";
		}
		else
		{
			...
			t.style.backgroundImage = "url('https://www24.53kf.com/style/chat/minichat2/img/min.png')";
		...
		}		$53("mini_header_bg_div").style.backgroundImage = "url('https://www24.53kf.com/style/chat/minichat2/img/header_bg_1.png')";
	}
	// 定时调用判断是否显示邀请框
	...
	{
		if(zdfq_switch == 'yes') {
			//document.cookie = "onliner_zdfq72200136="+onliner_zdfq;
			document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
		} else {
			document.cookie = "my_acc_reauto_time=null;path=/";
		}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function close_company_mini(){
		...
		// if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72200136="+onliner_zdfq;}
	...
	function ivt_seturl(zdy_yqk)
	{
		var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
			...
			if(vals[1])
			{
				...
				{
					case 'KF':
						var click_open_url = 'window.open(\"https://www24.53kf.com/webCompany.php?kf_sign=TMwMDMTU3MI0ODEwNzU5OTY5MjcxMDE1NzIyMDAxMzY=&arg=10200136&style=1&kflist=off&kf=nhlap985%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F3w.mj2812.cn%2Fwp%2Fniuhwap%2F&keyword=&brief=&logo=&question=&uid=9fc3ca6a5b41d0f5f997e3561199c219&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
						...
						break;
						//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www24.53kf.com/webCompany.php?kf_sign=TMwMDMTU3MI0ODEwNzU5OTY5MjcxMDE1NzIyMDAxMzY=&arg=10200136&style=1&kflist=off&kf=nhlap985%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F3w.mj2812.cn%2Fwp%2Fniuhwap%2F&keyword=&brief=&logo=&question=&uid=9fc3ca6a5b41d0f5f997e3561199c219&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
					case 'CLOSE':
						click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
					case 'ETEL':
						click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72200136&style_id=106270685\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
					case 'QQ':
						if(valst[1]){
							if(valst[1].toLowerCase().indexOf('biz') > -1){
								var qq = valst[1].replace('biz','');
								link_str = 'https://www24.53kf.com/bizqq.php?qq=' + qq + '&from=' + window.encodeURIComponent(window.location.href);
							}else{
